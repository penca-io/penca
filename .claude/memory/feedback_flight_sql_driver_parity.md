...
- **Related**: see the "Compose small single-responsibility functions" section of `docs/style-guide.md` (the helper extraction is the same composition discipline) and the "What to test" section of `docs/development-methodology-guide.md` (driver parametrization is one axis of the helper cross-product it describes).
