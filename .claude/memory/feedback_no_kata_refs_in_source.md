...
description: "Source code + commit messages must cite Linear CHA-XXX, not kata issue refs (fabric#xxxx). Kata IDs are ephemeral local-instance."
metadata: 
  node_type: memory
  type: feedback
...
Never reference kata issue IDs (`fabric#5f64`, `fabric#m898`, etc.) in
