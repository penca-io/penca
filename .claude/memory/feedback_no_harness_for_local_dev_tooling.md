...
**Local dev tooling does not earn regression tests.** Fix the bug, verify by hand, record the verification in the commit message, and move on. Do not propose extracting logic into a testable unit so a harness can drive it.
