...
forward-compatibly; this test activates when CHA-444's purge-past-snapshot
load-shed valve (``Pu > W_snap``) lands.
...
@pytest.mark.skip(
    reason="degradation recovery requires the CHA-444 purge-past-snapshot "
...
def test_snapshot_recovers_persisted_then_purged_table():
    ...
    # MISSING PIECE: a load-shed purge that advances Pu past W_snap (CHA-444
